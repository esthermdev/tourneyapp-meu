    ...
    <View style={styles.container}>
      ...
      >
        <Tab.Screen
          name="Round1"
          options={{ title: 'R1' }}
          children={() => <GameComponent roundId={1} datetimeId={1} division="MU" title="Round 1" />}
        />
        <Tab.Screen
          name="Round2"
          options={{ title: 'R2' }}
          children={() => <GameComponent roundId={1} datetimeId={2} division="MU" title="Round 2" />}
        />
        <Tab.Screen
          name="Round3"
          options={{ title: 'R3' }}
          children={() => <GameComponent roundId={1} datetimeId={3} division="MU" title="Round 3" />}
        />
      </Tab.Navigator>
    </View>
  );
