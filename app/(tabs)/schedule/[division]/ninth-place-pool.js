    ...
    <View style={styles.container}>
      ...
      >
        <Tab.Screen name="Round1" options={{ title: 'R1' }}>
          {() => <GameComponent roundId={20} datetimeId={1} division={code} title="Round 1" />}
        </Tab.Screen>
        <Tab.Screen name="Round2" options={{ title: 'R2' }}>
          {() => <GameComponent roundId={20} datetimeId={2} division={code} title="Round 2" />}
        </Tab.Screen>
        <Tab.Screen name="Round3" options={{ title: 'R3' }}>
          {() => <GameComponent roundId={20} datetimeId={3} division={code} title="Round 3" />}
        </Tab.Screen>
      </Tab.Navigator>
    </View>
  );
